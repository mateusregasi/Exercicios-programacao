...
int main(void){
  ...
  a->filhos[0]->n = 2;
  a->filhos[0]->chaves[0] = 1;
  a->filhos[0]->chaves[1] = 5;

  a->filhos[1]->n = 2;
  a->filhos[1]->chaves[0] = 10;
  a->filhos[1]->chaves[1] = 29;

  a->filhos[2]->n = 2;
  a->filhos[2]->chaves[0] = 30;
  a->filhos[2]->chaves[1] = 49;

  a->filhos[3]->n = 1;
  a->filhos[3]->chaves[0] = 50;
